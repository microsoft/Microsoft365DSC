...
$Global:FullComponents = @('AADGroup', 'AADServicePrincipal', 'EXOCalendarProcessing', 'EXOMailboxAutoReplyConfiguration', 'EXOMailboxSettings', `
        'EXOMailboxPermission', 'EXOManagementRole', 'O365Group', 'AADUSer', `
