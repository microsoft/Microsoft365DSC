Confirm-M365DSCModuleDependency -ModuleName 'MSFT_TeamsFilesPolicy'
...
function Get-TargetResource
{
    ...
    Write-Verbose -Message "Getting configuration for TeamsFilesPolicy $Identity"
    ...
    try
    {
        if (-not $Script:exportedInstance -or $Script:exportedInstance.Identity -ne $Identity)
        {
            ...
            $instance = Get-CsTeamsFilesPolicy -Identity $Identity -ErrorAction SilentlyContinue
        }
        else
        {
...
function Set-TargetResource
{
    ...
    Write-Verbose -Message "Setting configuration for TeamsFilesPolicy $Identity"
...
function Export-TargetResource
{
    ...
    try
    {
        [array]$getValue = Get-CsTeamsFilesPolicy -Filter $Filter -ErrorAction Stop
