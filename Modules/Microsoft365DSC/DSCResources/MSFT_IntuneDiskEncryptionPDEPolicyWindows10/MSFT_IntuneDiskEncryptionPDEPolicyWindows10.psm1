Confirm-M365DSCModuleDependency -ModuleName 'MSFT_IntuneDiskEncryptionPDEPolicyWindows10'
...
function Get-TargetResource
{
    ...
    Write-Verbose -Message "Getting configuration of the Intune Disk Encryption PDE Policy with Id {$Id} and DisplayName {$DisplayName}"
