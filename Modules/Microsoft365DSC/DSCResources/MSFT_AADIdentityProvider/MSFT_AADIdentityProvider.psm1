function Get-TargetResource
{
    ...
    try
    {
        ...
        #region resource generator code
        $getValue = Get-MgIdentityProvider `
            -ErrorAction Stop | Where-Object `
            -FilterScript {
                $_.AdditionalProperties.'@odata.type' -eq '#microsoft.graph.identityProvider' -and  $_.displayName -eq $($DisplayName)
            }

        if (-not $getValue)
        {
            [array]$getValue = Get-MgIdentityProvider `
                -ErrorAction Stop | Where-Object `
            -FilterScript {
                $_.id -eq $id
            }
...
function Set-TargetResource
{
    ...
    if ($Ensure -eq 'Present' -and $currentInstance.Ensure -eq 'Absent')
    {
        ...
        #region resource generator code
        New-MgIdentityProvider @CreateParameters
        #endregion
    ...
    elseif ($Ensure -eq 'Present' -and $currentInstance.Ensure -eq 'Present')
    {
        ...
        Update-MgIdentityProvider @UpdateParameters `
            -IdentityProviderId $currentInstance.Id
        #endregion
    ...
    elseif ($Ensure -eq 'Absent' -and $currentInstance.Ensure -eq 'Present')
    {
        ...
        #region resource generator code
        Remove-MgIdentityProvider -IdentityProviderId $currentInstance.Id
        #endregion
...
function Export-TargetResource
{
    ...
    try
    {
        ...
        [array]$getValue = Get-MgIdentityProvider `
            -ErrorAction Stop | Where-Object `
            -FilterScript {
                $_.AdditionalProperties.'@odata.type' -eq '#microsoft.graph.identityProvider' 
            }
...
function Get-M365DSCAdditionalProperties
{
    ...
    $results = @{"@odata.type" = "#microsoft.graph.identityProvider" }
