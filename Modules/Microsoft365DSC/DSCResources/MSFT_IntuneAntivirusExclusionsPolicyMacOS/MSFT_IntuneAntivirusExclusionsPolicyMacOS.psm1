Confirm-M365DSCModuleDependency -ModuleName 'MSFT_IntuneAntivirusExclusionsPolicyMacOS'
...
function Get-TargetResource
{
    ...
    Write-Verbose -Message "Getting configuration of the Intune Antivirus Exclusions Policy for macOS with Id {$Id} and DisplayName {$DisplayName}"
