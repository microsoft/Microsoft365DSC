...
function Set-TargetResource
{
    ...
    {
        Write-Verbose -Message "Creating an Azure AD Authentication Method Policy Email with id {$id}"
        ...
        #region resource generator code
        $CreateParameters.Add('@odata.type', '#microsoft.graph.emailAuthenticationMethodConfiguration')
...
function Test-TargetResource
{
    ...
    Write-Verbose -Message "Testing configuration of the Azure AD Authentication Method Policy Email with Id {$Id}"
