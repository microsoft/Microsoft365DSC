function Get-TargetResource
{
    ...
    try
    {
        ...
        if ($null -eq $getValue)
        {
            Write-Verbose -Message "Could not find an Intune Windows Autopilot Deployment Profile Azure A D Hybrid Joined with Id {$Id}"
        ...
        if ($null -eq $getValue)
        {
            Write-Verbose -Message "Could not find an Intune Windows Autopilot Deployment Profile Azure A D Hybrid Joined with DisplayName {$DisplayName}"
            return $nullResult
        }
        $Id = $getValue.Id
        Write-Verbose -Message "An Intune Windows Autopilot Deployment Profile Azure A D Hybrid Joined with Id {$Id} and DisplayName {$DisplayName} was found."
...
function Set-TargetResource
{
    ...
    {
        Write-Verbose -Message "Creating an Intune Windows Autopilot Deployment Profile Azure A D Hybrid Joined with DisplayName {$DisplayName}"
    ...
    {
        Write-Verbose -Message "Updating the Intune Windows Autopilot Deployment Profile Azure A D Hybrid Joined with Id {$($currentInstance.Id)}"
        $PSBoundParameters.Remove("Assignments") | Out-Null
    ...
    {
        Write-Verbose -Message "Removing the Intune Windows Autopilot Deployment Profile Azure A D Hybrid Joined with Id {$($currentInstance.Id)}" 
        #region resource generator code
...
function Test-TargetResource
{
    ...
    Write-Verbose -Message "Testing configuration of the Intune Windows Autopilot Deployment Profile Azure A D Hybrid Joined with Id {$Id} and DisplayName {$DisplayName}"
