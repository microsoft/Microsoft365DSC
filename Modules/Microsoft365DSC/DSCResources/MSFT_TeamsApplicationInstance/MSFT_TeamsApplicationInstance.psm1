Confirm-M365DSCModuleDependency -ModuleName 'MSFT_TeamsApplicationInstance'
...
function Get-TargetResource
{
    ...
    Write-Verbose -Message "Getting configuration for TeamsApplicationInstance $DisplayName"
    ...
    try
    {
        if (-not $Script:exportedInstance -or $Script:exportedInstance.DisplayName -ne $DisplayName)
        {
            ...
            $instance = Get-CsOnlineApplicationInstance -Identity $UserPrincipalName -ErrorAction SilentlyContinue
        }
        else
        {
...
function Set-TargetResource
{
    ...
    Write-Verbose -Message "Setting configuration for TeamsApplicationInstance $DisplayName"
    ...
    if (-not [System.String]::IsNullOrEmpty($ResourceAccountType))
    {
        ...
        elseif ($ResourceAccountType -eq 'CallQueue')
        {
    ...
    {
        Write-Verbose -Message "Updating application instance {$DisplayName}"
        Set-CsOnlineApplicationInstance -Identity $UserPrincipalName -DisplayName $DisplayName
    }
    # REMOVE
