Confirm-M365DSCModuleDependency -ModuleName 'MSFT_IntuneAppAndBrowserIsolationPolicyWindows10'
...
function Get-TargetResource
{
    ...
    Write-Verbose -Message "Getting configuration of the Intune App And Browser Isolation Policy for Windows10 with Id {$Id} and DisplayName {$DisplayName}"
