Confirm-M365DSCModuleDependency -ModuleName 'MSFT_EXOATPBuiltInProtectionRule'
...
function Set-TargetResource
{
    ...
    Write-Verbose -Message "Setting ATP Built-In Protection Rule with Identity $Identity"
