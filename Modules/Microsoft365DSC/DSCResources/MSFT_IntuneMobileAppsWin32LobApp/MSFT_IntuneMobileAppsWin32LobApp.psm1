function Get-TargetResource
{
    ...
    try
    {
        ...
        if ($null -eq $instance)
        {
          $instance = Get-MgBetaDeviceAppManagementMobileApp -MobileAppId $Id -ErrorAction Stop

          if ($null -eq $instance)
          {
              Write-Verbose -Message "Could not find MobileApp by Id {$Id}."
          ...
          if ($null -eq $instance)
          {
              Write-Verbose -Message "Could not find MobileApp by DisplayName {$DisplayName}."
              return $nullResult
          }
        }
...
function Export-TargetResource
{
    ...
    try
    {
        ...
        [array] $Script:exportedInstances = Get-MgBetaDeviceAppManagementMobileApp -ErrorAction Stop
