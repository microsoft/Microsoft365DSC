...
function Get-TargetResource
{
    ...
    Write-Verbose -Message "Getting configuration for Security Operations Override Rule with Identity {$Identity}"
    ...
    try
    {
        if (-not $Script:exportedInstance -or $Script:exportedInstance.Identity -ne $Identity)
        {
            ...
            if ($null -eq $instance)
            {
                Write-Verbose -Message "Could not find Security Operations Override Rule with Identity {$Identity}"
                return $nullResult
            }
        }
        else
        ...
        Write-Verbose -Message "Found Security Operations Override Rule with Identity {$Identity}"
...
function Set-TargetResource
{
    ...
    Write-Verbose -Message "Setting configuration for Security Operations Override Rule with Identity {$Identity}"
