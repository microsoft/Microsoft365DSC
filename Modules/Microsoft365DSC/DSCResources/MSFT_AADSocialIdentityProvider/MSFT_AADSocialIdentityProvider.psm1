Confirm-M365DSCModuleDependency -ModuleName 'MSFT_AADSocialIdentityProvider'
...
function Get-TargetResource
{
    ...
    try
    {
        if (-not $Script:exportedInstance -or $Script:exportedInstance.ClientId -ne $ClientId)
        {
