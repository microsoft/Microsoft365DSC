Confirm-M365DSCModuleDependency -ModuleName 'MSFT_IntuneDeviceConfigurationPolicyAndroidDeviceAdministrator'
...
function Get-TargetResource
{
    ...
    Write-Verbose -Message "Getting configuration of the Intune Device Configuration Policy Android Device Administrator with Id {$Id} and DisplayName {$DisplayName}"
...
function Set-TargetResource
{
    ...
    Write-Verbose -Message "Setting configuration of the Intune Device Configuration Policy Android Device Administrator with Id {$Id} and DisplayName {$DisplayName}"
