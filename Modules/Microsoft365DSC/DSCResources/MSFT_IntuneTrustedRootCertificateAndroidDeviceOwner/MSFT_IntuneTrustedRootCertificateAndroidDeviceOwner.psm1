Confirm-M365DSCModuleDependency -ModuleName 'MSFT_IntuneTrustedRootCertificateAndroidDeviceOwner'
...
function Set-TargetResource
{
    ...
    Write-Verbose -Message "Setting configuration of the Intune Trusted Root Certificate Policy for Android Device Owner with Id {$Id} and DisplayName {$DisplayName}"
    ...
    if ($Ensure -eq 'Present' -and $currentInstance.Ensure -eq 'Absent')
    {
        ...
        #region resource generator code
        $CreateParameters.Add('@odata.type', '#microsoft.graph.androidDeviceOwnerTrustedRootCertificate')
    ...
    elseif ($Ensure -eq 'Present' -and $currentInstance.Ensure -eq 'Present')
    {
        ...
        #region resource generator code
        $UpdateParameters.Add('@odata.type', '#microsoft.graph.androidDeviceOwnerTrustedRootCertificate')
