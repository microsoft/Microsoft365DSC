Confirm-M365DSCModuleDependency -ModuleName 'MSFT_AADFilteringPolicy'
...
function Export-TargetResource
{
    ...
    try
    {
        [array] $exportedInstances = Get-MgBetaNetworkAccessFilteringPolicy -All -Filter $Filter -ErrorAction Stop
