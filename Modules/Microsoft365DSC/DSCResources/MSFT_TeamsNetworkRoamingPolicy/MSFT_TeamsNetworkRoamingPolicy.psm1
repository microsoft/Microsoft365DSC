Confirm-M365DSCModuleDependency -ModuleName 'MSFT_TeamsNetworkRoamingPolicy'
...
function Get-TargetResource
{
    ...
    Write-Verbose -Message "Getting configuration for Teams Network Roaming Policy $Identity"
    ...
    try
    {
        if (-not $Script:exportedInstance -or $Script:exportedInstance.Identity -ne $Identity)
        {
            ...
            $instance = Get-CsTeamsNetworkRoamingPolicy -Identity $Identity -ErrorAction SilentlyContinue
        }
        else
        {
        ...
        $results = @{
            ...
            AllowIPVideo          = $instance.AllowIPVideo
            Description           = $instance.Description
            MediaBitRateKb        = $instance.MediaBitRateKb
            Ensure                = 'Present'
...
function Set-TargetResource
{
    ...
    Write-Verbose -Message "Setting configuration for Teams Network Roaming Policy $Identity"
...
function Export-TargetResource
{
    ...
    try
    {
        [array]$getValue = Get-CsTeamsNetworkRoamingPolicy -Filter $Filter -ErrorAction Stop
