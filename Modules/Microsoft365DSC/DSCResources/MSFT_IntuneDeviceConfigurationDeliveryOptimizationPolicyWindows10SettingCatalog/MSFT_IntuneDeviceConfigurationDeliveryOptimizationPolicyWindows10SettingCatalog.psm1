...
function Test-TargetResource
{
    ...
    Write-Verbose -Message "Testing configuration of the Intune Device Configuration Delivery Optimization Policy for Windows10 Setting Catalog with Id {$Id} and Name {$DisplayName}"
