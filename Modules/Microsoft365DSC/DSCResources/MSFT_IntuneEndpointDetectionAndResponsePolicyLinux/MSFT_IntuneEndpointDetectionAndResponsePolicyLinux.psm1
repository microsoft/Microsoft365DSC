Confirm-M365DSCModuleDependency -ModuleName 'MSFT_IntuneEndpointDetectionAndResponsePolicyLinux'
...
function Get-TargetResource
{
    ...
    Write-Verbose -Message "Getting configuration of the Intune Endpoint Detection And Response Policy Linux with Id {$Id} and Name {$DisplayName}"
