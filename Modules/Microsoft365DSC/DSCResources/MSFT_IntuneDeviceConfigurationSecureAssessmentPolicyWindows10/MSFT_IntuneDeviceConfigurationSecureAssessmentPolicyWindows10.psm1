function Get-TargetResource
{
    ...
    (
        ...
        [Parameter()]
        [ValidateSet('azureADAccount', 'domainAccount', 'localAccount', 'localGuestAccount')]
        [System.String]
    ...
    Write-Verbose -Message "Getting configuration of the Intune Device Configuration Secure Assessment Policy for Windows10 with Id {$Id} and DisplayName {$DisplayName}"
    ...
    try
    {
        if (-not $Script:exportedInstance)
        {
            ...
            if ($null -eq $getValue)
            {
                Write-Verbose -Message "Could not find an Intune Device Configuration Secure Assessment Policy for Windows10 with Id {$Id}"
            ...
            if ($null -eq $getValue)
            {
                Write-Verbose -Message "Could not find an Intune Device Configuration Secure Assessment Policy for Windows10 with DisplayName {$DisplayName}"
                return $nullResult
            }
        }
        else
        ...
        $Id = $getValue.Id
        Write-Verbose -Message "An Intune Device Configuration Secure Assessment Policy for Windows10 with Id {$Id} and DisplayName {$DisplayName} was found."
