Confirm-M365DSCModuleDependency -ModuleName 'MSFT_AADAuthenticationMethodPolicySoftware'
...
function Get-TargetResource
{
    ...
    Write-Verbose -Message "Getting the Azure AD Authentication Method Policy Software with Id {$Id}"
...
function Set-TargetResource
{
    ...
    Write-Verbose -Message "Setting the Azure AD Authentication Method Policy Software with Id {$Id}"
