Confirm-M365DSCModuleDependency -ModuleName 'MSFT_IntuneSecurityBaselineMicrosoft365AppsForEnterprise'
...
function Get-TargetResource
{
    ...
    Write-Verbose -Message "Getting configuration of the Intune Security Baseline Microsoft365 Apps For Enterprise with Id {$Id} and DisplayName {$DisplayName}."
