...
@{
  ...
  PrivateData       = @{
    ...
    PSData = @{
      ...
      * Fix Could not find Location 00000000-0000-0000-0000-000000000000
    ...
    * SCLabelPolicy
      * Fixed issue where the Labels parameter is not handled properly for existing
        policies
    ...
    * SCSensitivityLabel
      ...
      * Corrected issue where SiteAndGroupExternalSharingControlType was not
