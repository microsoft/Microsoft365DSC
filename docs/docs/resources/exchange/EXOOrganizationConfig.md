...
| **AllowPlusAddressInRecipients** | Write | Boolean | The AllowPlusAddressInRecipients parameter enables or disables dynamic, disposable subaddressing as defined in RFC 5233. ||
...
| **BookingsEnabled** | Write | Boolean | The BookingsEnabled parameter specifies whether to enable Microsoft Bookings in an Exchange Online organization. ||
