...
| **MailboxMoveCapability** | Write | String | The MailboxMoveCapability parameter is used in cross-tenant mailbox migrations. |Inbound, Outbound, RemoteInbound, RemoteOutbound|
