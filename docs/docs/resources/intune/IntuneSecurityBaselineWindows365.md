...
| **IZ_PolicyLogon_1_IZ_Partname1A00** | Write | SInt32 | Logon options - Depends on IZ_PolicyLogon_1 (196608: Anonymous logon, 131072: Automatic logon only in Intranet zone, 0: Automatic logon with current username and password, 65536: Prompt for user name and password) | `196608`, `131072`, `0`, `65536` |
...
| **IZ_PolicyLogon_7_IZ_Partname1A00** | Write | SInt32 | Logon options - Depends on IZ_PolicyLogon_7 (196608: Anonymous logon, 131072: Automatic logon only in Intranet zone, 0: Automatic logon with current username and password, 65536: Prompt for user name and password) | `196608`, `131072`, `0`, `65536` |
...
| **MicrosoftEdge_ContentSettings_DefaultPluginsSetting** | Write | SInt32 | Default Adobe Flash setting (0: Disabled, 1: Enabled) | `0`, `1` |
| **DefaultPluginsSetting_DefaultPluginsSetting** | Write | SInt32 | Default Adobe Flash setting (Device) - Depends on MicrosoftEdge_ContentSettings_DefaultPluginsSetting (2: Block the Adobe Flash plugin, 3: Click to play) | `2`, `3` |
| **edge_SSLVersionMin** | Write | SInt32 | Minimum TLS version enabled (0: Disabled, 1: Enabled) | `0`, `1` |
...
| **MicrosoftEdge_ContentSettings_DefaultPluginsSetting** | Write | SInt32 | Default Adobe Flash setting (User) (0: Disabled, 1: Enabled) | `0`, `1` |
| **DefaultPluginsSetting_DefaultPluginsSetting** | Write | SInt32 | Default Adobe Flash setting (User) - Depends on MicrosoftEdge_ContentSettings_DefaultPluginsSetting (2: Block the Adobe Flash plugin, 3: Click to play) | `2`, `3` |
| **edge_SSLVersionMin** | Write | SInt32 | Minimum TLS version enabled (User) (0: Disabled, 1: Enabled) | `0`, `1` |
