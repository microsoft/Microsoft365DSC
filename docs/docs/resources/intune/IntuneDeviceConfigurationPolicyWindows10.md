...
| **DefenderDetectedMalwareActions** | Write | MSFT_IntuneDefenderDetectedMalwareActions | Gets or sets Defenders actions to take on detected Malware per threat level. | |
...
### MSFT_IntuneDefenderDetectedMalwareActions
