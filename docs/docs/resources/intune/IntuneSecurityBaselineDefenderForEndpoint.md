...
| **EncryptionMethodWithXts_Name** | Write | SInt32 | Choose drive encryption method and cipher strength (Windows 10 [Version 1511] and later) (0: Disabled, 1: Enabled) | `0`, `1` |
...
| **FDVRecoveryUsage_Name** | Write | SInt32 | Choose how BitLocker-protected fixed drives can be recovered (0: Disabled, 1: Enabled) | `0`, `1` |
| **FDVActiveDirectoryBackup_Name** | Write | SInt32 | Save BitLocker recovery information to AD DS for fixed data drives - Depends on FDVRecoveryUsage_Name (0: False, 1: True) | `0`, `1` |
| **FDVHideRecoveryPage_Name** | Write | SInt32 | Omit recovery options from the BitLocker setup wizard - Depends on FDVRecoveryUsage_Name (0: False, 1: True) | `0`, `1` |
...
| **FDVRequireActiveDirectoryBackup_Name** | Write | SInt32 | Do not enable BitLocker until recovery information is stored to AD DS for fixed data drives - Depends on FDVRecoveryUsage_Name (0: False, 1: True) | `0`, `1` |
| **FDVAllowDRA_Name** | Write | SInt32 | Allow data recovery agent - Depends on FDVRecoveryUsage_Name (0: False, 1: True) | `0`, `1` |
...
| **FDVEncryptionType_Name** | Write | SInt32 | Enforce drive encryption type on fixed data drives (0: Disabled, 1: Enabled) | `0`, `1` |
...
| **EnablePreBootPinExceptionOnDECapableDevice_Name** | Write | SInt32 | Allow devices compliant with InstantGo or HSTI to opt out of pre-boot PIN. (0: Disabled, 1: Enabled) | `0`, `1` |
| **EnhancedPIN_Name** | Write | SInt32 | Allow enhanced PINs for startup (0: Disabled, 1: Enabled) | `0`, `1` |
| **OSRecoveryUsage_Name** | Write | SInt32 | Choose how BitLocker-protected operating system drives can be recovered (0: Disabled, 1: Enabled) | `0`, `1` |
| **OSRequireActiveDirectoryBackup_Name** | Write | SInt32 | Do not enable BitLocker until recovery information is stored to AD DS for operating system drives - Depends on OSRecoveryUsage_Name (0: False, 1: True) | `0`, `1` |
| **OSActiveDirectoryBackup_Name** | Write | SInt32 | Save BitLocker recovery information to AD DS for operating system drives - Depends on OSRecoveryUsage_Name (0: False, 1: True) | `0`, `1` |
...
| **OSHideRecoveryPage_Name** | Write | SInt32 | Omit recovery options from the BitLocker setup wizard - Depends on OSRecoveryUsage_Name (0: False, 1: True) | `0`, `1` |
| **OSAllowDRA_Name** | Write | SInt32 | Allow data recovery agent - Depends on OSRecoveryUsage_Name (0: False, 1: True) | `0`, `1` |
...
| **EnablePrebootInputProtectorsOnSlates_Name** | Write | SInt32 | Enable use of BitLocker authentication requiring preboot keyboard input on slates (0: Disabled, 1: Enabled) | `0`, `1` |
| **OSEncryptionType_Name** | Write | SInt32 | Enforce drive encryption type on operating system drives (0: Disabled, 1: Enabled) | `0`, `1` |
...
| **ConfigureAdvancedStartup_Name** | Write | SInt32 | Require additional authentication at startup (0: Disabled, 1: Enabled) | `0`, `1` |
...
| **ConfigureNonTPMStartupKeyUsage_Name** | Write | SInt32 | Allow BitLocker without a compatible TPM (requires a password or a startup key on a USB flash drive) - Depends on ConfigureAdvancedStartup_Name (0: False, 1: True) | `0`, `1` |
...
| **RDVConfigureBDE** | Write | SInt32 | Control use of BitLocker on removable drives (0: Disabled, 1: Enabled) | `0`, `1` |
| **RDVAllowBDE_Name** | Write | SInt32 | Allow users to apply BitLocker protection on removable data drives (Device) - Depends on RDVConfigureBDE (0: False, 1: True) | `0`, `1` |
| **RDVEncryptionType_Name** | Write | SInt32 | Enforce drive encryption type on removable data drives (0: Disabled, 1: Enabled) | `0`, `1` |
...
| **RDVDisableBDE_Name** | Write | SInt32 | Allow users to suspend and decrypt BitLocker protection on removable data drives (Device) - Depends on RDVConfigureBDE (0: False, 1: True) | `0`, `1` |
...
| **AllowWarningForOtherDiskEncryption** | Write | SInt32 | Allow Warning For Other Disk Encryption (0: Disabled, 1: Enabled) | `0`, `1` |
| **AllowStandardUserEncryption** | Write | SInt32 | Allow Standard User Encryption - Depends on AllowWarningForOtherDiskEncryption (0: This is the default, when the policy is not set. If current logged on user is a standard user, 'RequireDeviceEncryption' policy will not try to enable encryption on any drive., 1: 'RequireDeviceEncryption' policy will try to enable encryption on all fixed drives even if a current logged in user is standard user.) | `0`, `1` |
...
| **SmartScreenDnsRequestsEnabled** | Write | SInt32 | Enable Microsoft Defender SmartScreen DNS requests (0: Disabled, 1: Enabled) | `0`, `1` |
| **NewSmartScreenLibraryEnabled** | Write | SInt32 | Enable new SmartScreen library (0: Disabled, 1: Enabled) | `0`, `1` |
| **SmartScreenForTrustedDownloadsEnabled** | Write | SInt32 | Force Microsoft Defender SmartScreen checks on downloads from trusted sources (0: Disabled, 1: Enabled) | `0`, `1` |
...
| Parameter | Attribute | DataType | Description | Allowed Values |
| --- | --- | --- | --- | --- |
| **DisableSafetyFilterOverrideForAppRepUnknown** | Write | SInt32 | Prevent bypassing SmartScreen Filter warnings about files that are not commonly downloaded from the Internet (User) (0: Disabled, 1: Enabled) | `0`, `1` |
