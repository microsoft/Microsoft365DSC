...
| **localizedMessages** | Write | InstanceArray[] | The list of <locale, message> pairs. This collection can contain a maximum of 500 elements. ||
...
| **item** | Write | Instance | Item to be arranged. ||
...
| **items** | Write | InstanceArray[] | Item to be arranged. ||
...
| **AzureAdSharedDeviceDataClearApps** | Write | InstanceArray[] | A list of managed apps that will have their data cleared during a global sign-out in AAD shared device mode. This collection can contain a maximum of 500 elements. ||
...
| **DetailedHelpText** | Write | Instance | Represents the customized detailed help text provided to users when they attempt to modify managed settings on their device. ||
| **DeviceOwnerLockScreenMessage** | Write | Instance | Represents the customized lock screen message provided to users when they attempt to modify managed settings on their device. ||
...
| **GlobalProxy** | Write | Instance | Proxy is set up directly with host, port and excluded hosts. ||
...
| **KioskModeAppPositions** | Write | InstanceArray[] | The ordering of items on Kiosk Mode Managed Home Screen. This collection can contain a maximum of 500 elements. ||
| **KioskModeApps** | Write | InstanceArray[] | A list of managed apps that will be shown when the device is in Kiosk Mode. This collection can contain a maximum of 500 elements. ||
...
| **KioskModeManagedFolders** | Write | InstanceArray[] | A list of managed folders for a device in Kiosk Mode. This collection can contain a maximum of 500 elements. ||
...
| **PersonalProfilePersonalApplications** | Write | InstanceArray[] | Policy applied to applications in the personal profile. This collection can contain a maximum of 500 elements. ||
...
| **ShortHelpText** | Write | Instance | Represents the customized short help text provided to users when they attempt to modify managed settings on their device. ||
...
| **SystemUpdateFreezePeriods** | Write | InstanceArray[] | Indicates the annually repeating time periods during which system updates are postponed. This collection can contain a maximum of 500 elements. ||
