...
![Infographic](../media/M365DSC-InfoGraphic.png){ align=center width=500 }

## Automate ![Infographic](../media/Automate.png){ align=left width=100 }
...
See the [Automating](Automating) page for more information about possible options.

## Export ![Infographic](../media/Export.png){ align=left width=100 }
...
![ExportUI](../media/ExportUI.png){ align=center width=500 }
...
See the [Exporting](Exporting) page for more information about possible options.

## Synchronize ![Infographic](../media/Synchronize.png){ align=left width=100 }
...
![SyncFlow](../media/SyncFlow.png){ align=center width=500 }
...
## Assess ![Infographic](../media/Assess.png){ align=left width=100 }
...
![AssessFlowBlueprint](../media/AssessFlowBlueprint.png){ align=center width=500 }
...
![AssessFlowTenant](../media/AssessFlowTenant.png){ align=center width=500 }

See the [Assessing](Assessing) page for more information about possible options.

## Monitor ![Infographic](../media/Monitor.png){ align=left width=100 }
...
![MonitorFlow](../media/MonitorFlow.png){ align=center width=500 }

See the [Monitoring](Monitoring) page for more information about possible options.

## Report ![Infographic](../media/Report.png){ align=left width=100 }
...
![ReportFlow](../media/ReportFlow.png){ align=center width=500 }

See the [Reporting](Reporting) page for more information about possible options.
