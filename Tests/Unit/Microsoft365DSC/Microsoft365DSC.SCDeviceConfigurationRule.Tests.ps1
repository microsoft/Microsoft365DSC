...
Describe -Name $Global:DscHelper.DescribeHeader -Fixture {
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        BeforeAll {
            ...
            Mock -CommandName New-DeviceConfigurationRule -MockWith {
            }

            Mock -CommandName Set-DeviceConfigurationRule -MockWith {
            }

            Mock -CommandName Remove-DeviceConfigurationRule -MockWith {
            }
