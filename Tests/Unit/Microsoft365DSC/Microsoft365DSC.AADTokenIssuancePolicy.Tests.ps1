...
Describe -Name $Global:DscHelper.DescribeHeader -Fixture {
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        BeforeAll {
            ...
            Mock -CommandName New-MgBetaPolicyTokenIssuancePolicy -MockWith {
            }

            Mock -CommandName Update-MgBetaPolicyTokenIssuancePolicy -MockWith {
            }
        ...
        Context -Name "The instance should exist but it DOES NOT" -Fixture {
            ...
            It 'Should create a new instance from the Set method' {
                ...
                Should -Invoke -CommandName New-MgBetaPolicyTokenIssuancePolicy -Exactly 1
            }
        }
        ...
        Context -Name "The instance exists but it SHOULD NOT" -Fixture {
            ...
            It 'Should remove the instance from the Set method' {
                Set-TargetResource @testParams
                Should -Invoke -CommandName Remove-MgBetaPolicyTokenIssuancePolicy -Exactly 1
            }
        }
        ...
        Context -Name "The instance exists and values are NOT in the desired state" -Fixture {
            ...
            It 'Should call the Set method' {
                Set-TargetResource @testParams
                Should -Invoke -CommandName Update-MgBetaPolicyTokenIssuancePolicy -Exactly 1
            }
        }
