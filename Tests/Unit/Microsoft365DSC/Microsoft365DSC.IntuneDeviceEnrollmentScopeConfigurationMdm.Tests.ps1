...
$Global:DscHelper = New-M365DscUnitTestHelper -StubModule $CmdletModule `
    -DscResource "IntuneDeviceEnrollmentScopeConfigurationMdm" -GenericStubModule $GenericStubPath
Describe -Name $Global:DscHelper.DescribeHeader -Fixture {
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        # Test contexts
        Context -Name "The IntuneDeviceEnrollmentScopeConfigurationMdm Exists and Values are already in the desired state" -Fixture {
            BeforeAll {
                $testParams = @{
                    AppliesTo = "Selected"
                    ComplianceUrl = "FakeStringValue"
        ...
        Context -Name "The IntuneDeviceEnrollmentScopeConfigurationMdm exists and values are NOT in the desired state" -Fixture {
            BeforeAll {
                $testParams = @{
                    AppliesTo = "Selected"
                    ComplianceUrl = "FakeStringValue"
