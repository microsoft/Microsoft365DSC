...
$Global:DscHelper = New-M365DscUnitTestHelper -StubModule $CmdletModule `
    -DscResource "IntuneMobileAppsWebLink" -GenericStubModule $GenericStubPath
Describe -Name $Global:DscHelper.DescribeHeader -Fixture {
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        # Test contexts
        Context -Name "The IntuneMobileAppsWebLink should exist but it DOES NOT" -Fixture {
            BeforeAll {
                $testParams = @{
                    TargetType = "webApp"
                    AppUrl = "FakeStringValue"
        ...
        Context -Name "The IntuneMobileAppsWebLink exists but it SHOULD NOT" -Fixture {
            BeforeAll {
                $testParams = @{
                    TargetType = "webApp"
                    AppUrl = "FakeStringValue"
        ...
        Context -Name "The IntuneMobileAppsWebLink Exists and Values are already in the desired state" -Fixture {
            BeforeAll {
                $testParams = @{
                    TargetType = "webApp"
                    AppUrl = "FakeStringValue"
        ...
        Context -Name "The IntuneMobileAppsWebLink exists and values are NOT in the desired state" -Fixture {
            BeforeAll {
                $testParams = @{
                    TargetType = "webApp"
                    AppUrl = "FakeStringValue"
