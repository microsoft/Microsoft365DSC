...
Describe -Name $Global:DscHelper.DescribeHeader -Fixture {
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        BeforeAll {
            ...
            Context -Name "When the Android Device Owner Compliance Policy already exists and is NOT in the Desired State" -Fixture {
                BeforeAll {
                    $testParams = @{
                    ...
                    Mock -CommandName Get-IntuneDeviceCompliancePolicy -MockWith {
                        return @{
                            Description                                        = "Test Android Device Owner Device Compliance Policy Description";
                            DisplayName                                        = "Test Android Device Owner Device Compliance Policy";
                            Id                                                 = '9c4e2ed7-706e-4874-a826-0c2778352a67'
                            DeviceThreatProtectionEnabled                      = $False;
                            DeviceThreatProtectionRequiredSecurityLevel        = "unavailable";
                            AdvancedThreatProtectionRequiredSecurityLevel      = "unavailable";
                            SecurityRequireSafetyNetAttestationBasicIntegrity  = $False;
            ...
            Context -Name "When the policy exists and it SHOULD NOT" -Fixture {
                BeforeAll {
                    $testParams = @{
                        ...
                        RoleScopeTagIds                                    = "0"
                        Ensure                                             = "Present";
                        GlobalAdminAccount                                 = $Credsglobaladmin;t
                    }
