...
$Global:DscHelper = New-M365DscUnitTestHelper -StubModule $CmdletModule `
    -DscResource 'IntuneTrustedRootCertificateAndroidDeviceOwner' -GenericStubModule $GenericStubPath
Describe -Name $Global:DscHelper.DescribeHeader -Fixture {
    InModuleScope -ModuleName $Global:DscHelper.ModuleName -ScriptBlock {
        ...
        # Test contexts
        Context -Name "When the IntuneTrustedRootCertificateAndroidDeviceOwner doesn't already exist" -Fixture {
            BeforeAll {
                $testParams = @{
            ...
            It 'Should create the IntuneTrustedRootCertificateAndroidDeviceOwner from the Set method' {
                Set-TargetResource @testParams
                Should -Invoke -CommandName 'New-MgBetaDeviceManagementDeviceConfiguration' -Exactly 1
            }
        }

        Context -Name 'When the IntuneTrustedRootCertificateAndroidDeviceOwner already exists and is NOT in the Desired State' -Fixture {
            BeforeAll {
                $testParams = @{
                    DisplayName                = 'Test IntuneTrustedRootCertificateAndroidDeviceOwner'
                    Description                = 'Test IntuneTrustedRootCertificateAndroidDeviceOwner Description'
        ...
        Context -Name 'When the policy exists and it SHOULD NOT' -Fixture {
            ...
            It 'Should remove the IntuneTrustedRootCertificateAndroidDeviceOwner from the Set method' {
                Set-TargetResource @testParams
