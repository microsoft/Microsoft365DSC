...
'@
    ...
    {
        $examplesPath = './Modules/Microsoft365DSC/Examples/Resources'
    }

    $workloadExamplesPath = Join-Path -Path $examplesPath -ChildPath "$Workload*"
    $exampleFiles = Get-ChildItem -Path $workloadExamplesPath -Filter "*$Step.ps1" -Recurse
