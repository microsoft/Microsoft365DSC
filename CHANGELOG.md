...
- General
  - Fixed typos: corrected "Elegibility" to "Eligibility" in code, schema, and documentation.
...
- MISC
  - Modified the drift logging logic to include the MSFT\_ prefix
...
- AADRoleEligibilityScheduleRequest
  ...
  - Fixes to remove eligibility schedule for custom roles.
